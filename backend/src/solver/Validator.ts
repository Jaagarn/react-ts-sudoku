...
const solved = (board: CellData[]): boolean => {
...
const solvableString = (board: string): boolean => solvable(stringToCells(board));

export { solved, solvable, columns, column, square, solvedSet, solvableSet, solvableString };